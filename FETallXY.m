function [LF,LB,SF,SB] = FETallXY(folder,CHLarray,type,Vds,Ids_col,Vgs_col,smFAC)
format short e;
...
DevPar(3)=Ci;
    ...
    for i=1:size(CHLarray,2)
        ...
        display(['analysed ' num2str(2*i+j-2) ' / ' num2str(size(CHLarray,2)*2)]);%for displaying progress purpose
