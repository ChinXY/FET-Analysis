function [Mu_lin,Vth_lin,Vgs_lin,Mu_sat,Vth_sat,Vgs_sat] = FETanalysisXY(folder,file,Vds,Ids_col,Vgs_col,smFAC,DevPar)
    format short e;
    ...
    [Vgs,~,absIds,sqrtIds] = FETdataimport1(folder,file,Vds,Ids_col,Vgs_col);
    %[Vgs,~,absIds,sqrtIds] = FETdataimport2(folder,file,Vds,Ids_col,Vgs_col);
